...
import { ZoomIn, ZoomOut, Maximize, Settings, Play, Pause, Target, Circle } from 'lucide-react';
...
function findNeighborNodes(startNodeId: string, edges: GraphEdge[], maxDepth: number): Set<string> {
...
function resolveNodeColor(
  ...
  for (const group of groups) {
    const matchesLabel =
      group.query && nodeData.label.toLowerCase().includes(group.query.toLowerCase());
    const matchesTag =
      group.query && nodeData.tags?.some(t => t.toLowerCase().includes(group.query.toLowerCase()));
...
export default function GraphView({ userId, notes, onNoteSelect }: GraphViewProps) {
  ...
  const nodesRef = useRef<
    Map<string, { graphics: PIXI.Graphics; text: PIXI.Text; data: NodeData }>
  >(new Map());
  ...
  const createNode = useCallback((nodeData: NodeData) => {
    ...
    const labelVisible =
      graphSettings.showLabels && (nodeData.type === 'main' || zoom > 1.5 - textFadeThreshold);
  ...
  const computeEdgeStyle = useCallback(
    (edge: EdgeData) => {
  ...
  const drawEdges = useCallback(
    (edges: EdgeData[], nodePositions: Map<string, { x: number; y: number }>) => {
      if (!edgesRef.current) {
        return;
      }
  ...
  useEffect(() => {
    const loadGraph = async () => {
      ...
      if (!isPixiReady || !appRef.current) {
        console.warn(
          `⚠️ [GraphView] PIXI pas prêt encore - abandon (isPixiReady=${isPixiReady}, appRef=${!!appRef.current})`
        );
        return;
      }
          ...
          <div className="grid grid-cols-1 laptop:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <h4 className="text-xs font-medium text-neutral-300 uppercase tracking-wide border-b border-neutral-700 pb-1">
                  Filtres
                </h4>

                <div className="flex items-center justify-between">
                  <label htmlFor="show-orphans-toggle" className="text-xs text-neutral-400">
                    Notes isolées
                  </label>
                  <button
                    ...
                    type="button"
                    onClick={() => {
                      setGraphSettings(prev => ({ ...prev, showOrphans: !prev.showOrphans }));
                    }}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setGraphSettings(prev => ({
                        ...prev,
                        minLinks: Number.parseInt(e.target.value, 10),
                      }));
                    }}
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    value={newGroupQuery}
                    onChange={e => {
                      setNewGroupQuery(e.target.value);
                    }}
                ...
                <div className="space-y-2 max-h-32 overflow-y-auto">
                  {groups.map(group => (
                    <div
                      ...
                      className="flex items-center gap-2 bg-neutral-900 p-1.5 rounded border border-neutral-800"
                    >
                      ...
                      <button
                        onClick={() => {
                          setGroups(groups.filter(g => g.query !== group.query));
                        }}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <label htmlFor="show-arrows-toggle" className="text-xs text-neutral-400">
                    Flèches
                  </label>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <label htmlFor="show-labels-toggle" className="text-xs text-neutral-400">
                    Étiquettes
                  </label>
                  <button
                    ...
                    type="button"
                    onClick={() => {
                      setGraphSettings(prev => ({ ...prev, showLabels: !prev.showLabels }));
                    }}
                    className={`w-8 h-4 rounded-full transition-colors relative ${
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setTextFadeThreshold(Number.parseFloat(e.target.value));
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setGraphSettings(prev => ({
                        ...prev,
                        nodeSize: Number.parseFloat(e.target.value),
                      }));
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setGraphSettings(prev => ({
                        ...prev,
                        linkThickness: Number.parseFloat(e.target.value),
                      }));
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setPhysicsParams({
                        ...physicsParams,
                        centerForce: Number.parseFloat(e.target.value),
                      });
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setPhysicsParams({
                        ...physicsParams,
                        repulsion: Number.parseFloat(e.target.value),
                      });
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setPhysicsParams({
                        ...physicsParams,
                        attraction: Number.parseFloat(e.target.value),
                      });
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => {
                      setPhysicsParams({
                        ...physicsParams,
                        linkDistance: Number.parseFloat(e.target.value),
                      });
                    }}
                    className="w-full accent-blue-500 h-1 bg-neutral-700 rounded-lg appearance-none cursor-pointer"
                  />
