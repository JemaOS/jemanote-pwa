...
describe('AIPanel', () => {
  ...
  describe('Tags Tab', () => {
    it('should generate tags', async () => {
      ...
      await waitFor(() => {
        expect(aiService.generateTags).toHaveBeenCalledWith(defaultProps.currentNote?.content, 8);
      });
    });
  ...
  describe('Brainstorm Tab', () => {
    ...
    it('should generate ideas', async () => {
      ...
      await waitFor(() => {
        expect(aiService.generateIdeas).toHaveBeenCalledWith('Test Note 1', 'Content of note 1');
      });
    });
