...
describe('AuthModal', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render description', () => {
      render(<AuthModal {...defaultProps} />)
      expect(screen.getByText('Connectez-vous pour synchroniser vos notes sur tous vos appareils')).toBeInTheDocument()
    })
  ...
  describe('Modal Closing', () => {
    ...
    it('should close modal when clicking backdrop', async () => {
      ...
      const backdrop = screen.getByText('Synchronisation Cloud').parentElement?.parentElement?.parentElement
      if (backdrop) {
  ...
  describe('Informational Text', () => {
    it('should show sync info text', () => {
      render(<AuthModal {...defaultProps} />)
      expect(screen.getByText('Vos notes locales seront automatiquement synchronisées après connexion')).toBeInTheDocument()
    })
  })
})
