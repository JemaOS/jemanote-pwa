...
describe('CommandPalette', () => {
  ...
  describe('Rendering', () => {
    it('should not render when closed', () => {
      ...
      expect(screen.queryByPlaceholderText('Rechercher des commandes ou des notes...')).not.toBeInTheDocument()
    })

    it('should render when open', () => {
      render(<CommandPalette {...defaultProps} />)
      expect(screen.getByPlaceholderText('Rechercher des commandes ou des notes...')).toBeInTheDocument()
    })
  ...
  describe('Backdrop', () => {
    it('should close when clicking backdrop', async () => {
      ...
      const backdrop = screen.getByPlaceholderText('Rechercher des commandes ou des notes...')
  ...
  describe('Styling', () => {
    ...
    it('should have modal styling', () => {
      render(<CommandPalette {...defaultProps} />)
      const modal = screen.getByPlaceholderText('Rechercher des commandes ou des notes...')
