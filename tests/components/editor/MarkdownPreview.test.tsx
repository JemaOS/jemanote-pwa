...
vi.mock('@/components/ui/WaveformPlayer', () => ({
  default: ({ blob }: { blob: Blob }) => (
    <div data-testid="waveform-player">Audio Player</div>
  ),
}))
...
- Item 3`
  ...
  describe('Wiki Links', () => {
    ...
    it('should call onWikiLinkClick when clicking wiki link', async () => {
      ...
      render(<MarkdownPreview {...defaultProps} content="[[Note Title]]" onWikiLinkClick={onWikiLinkClick} />)
...
| Cell 3   | Cell 4   |`
  ...
  describe('Audio Attachments', () => {
    ...
    it('should handle audio element with data-attachment-id', () => {
      render(<MarkdownPreview {...defaultProps} content='<audio data-attachment-id="audio-123"></audio>' />)
