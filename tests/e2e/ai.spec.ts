...
test.describe('AI Features', () => {
  ...
  test.describe('AI Summary Generation', () => {
    test('should generate summary of note', async ({ page }) => {
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        const summaryButton = page.getByRole('button', { name: /résumer|summarize|générer un résumé/i }).first()
        if (await summaryButton.isVisible().catch(() => false)) {
          ...
          const summaryOutput = page.locator('.ai-summary, [data-testid="ai-summary"], .summary-result').first()
    ...
    test('should suggest tags for note', async ({ page }) => {
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await tagsTab.isVisible().catch(() => false)) {
          ...
          const suggestButton = page.getByRole('button', { name: /suggérer|suggest|générer tags/i }).first()
          if (await suggestButton.isVisible().catch(() => false)) {
            ...
            const suggestedTags = page.locator('.suggested-tag, .ai-tag, [data-testid="suggested-tag"]')
  ...
  test.describe('AI Text Analysis', () => {
    ...
    test('should improve text', async ({ page }) => {
      ...
      const improveButton = page.getByRole('button', { name: /améliorer|improve|enhance/i }).first()
    ...
    test('should change tone of text', async ({ page }) => {
      ...
      if (await toneButton.isVisible().catch(() => false)) {
        ...
        // Select formal tone
        const formalOption = page.getByRole('button', { name: /formel|formal|professionnel/i }).first()
  ...
  test.describe('AI Translation', () => {
    ...
    test('should translate text to multiple languages', async ({ page }) => {
      ...
      if (await translateButton.isVisible().catch(() => false)) {
        ...
        const languageOptions = page.getByRole('button').filter({ hasText: /français|espagnol|allemand|italien|french|spanish|german|italian/i })
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await brainstormTab.isVisible().catch(() => false)) {
          ...
          if (await topicInput.isVisible().catch(() => false)) {
            ...
            const generateButton = page.getByRole('button', { name: /générer|generate|idées/i }).first()
            await generateButton.click()
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await brainstormTab.isVisible().catch(() => false)) {
          ...
          if (await topicInput.isVisible().catch(() => false)) {
            ...
            const createNoteButton = page.getByRole('button', { name: /créer note|create note/i }).first()
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await synthesisTab.isVisible().catch(() => false)) {
          ...
          if (count > 0) {
            ...
            const synthesizeButton = page.getByRole('button', { name: /synthétiser|synthesize/i }).first()
    ...
    test('should suggest links between notes', async ({ page }) => {
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await linksTab.isVisible().catch(() => false)) {
          ...
          const detectButton = page.getByRole('button', { name: /détecter|detect|suggérer liens/i }).first()
    ...
    test('should handle API errors gracefully', async ({ page }) => {
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await summaryButton.isVisible().catch(() => false)) {
          ...
          const resultOrError = page.locator('.ai-summary, .ai-error, .error-message, [data-testid="ai-result"]').first()
    ...
    test('should show loading state', async ({ page }) => {
      ...
      if (await aiButton.isVisible().catch(() => false)) {
        ...
        if (await summaryButton.isVisible().catch(() => false)) {
          ...
          const loadingIndicator = page.locator('.loading, .spinner, [data-testid="loading"], .animate-spin').first()
