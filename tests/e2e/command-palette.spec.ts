...
test.describe('Command Palette', () => {
  ...
  test.describe('Opening Command Palette', () => {
    test('should open with Cmd+K', async ({ page }) => {
      ...
      const commandPalette = page.locator('[cmdk-root], .command-palette, [data-testid="command-palette"]').first()
  ...
  test.describe('Searching Commands', () => {
    test('should display search input', async ({ page }) => {
      ...
      const searchInput = page.locator('[cmdk-input], input[placeholder*="rechercher" i], input[placeholder*="search" i]').first()
  ...
  test.describe('Executing Commands', () => {
    test('should create new note from command', async ({ page }) => {
      ...
      const newNoteCommand = page.getByRole('option', { name: /nouvelle note|new note|créer/i }).first()
    ...
    test('should toggle theme', async ({ page }) => {
      ...
      const themeCommand = page.getByRole('option', { name: /thème|theme|sombre|clair|dark|light/i }).first()
