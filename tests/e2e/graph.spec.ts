...
test.describe('Graph View', () => {
  ...
  test.describe('Graph Visualization', () => {
    test('should display graph view', async ({ page }) => {
      ...
      const graphCanvas = page
        .locator('canvas, .graph-container, [data-testid="graph-view"]')
        .first();
  ...
  test.describe('Graph Settings', () => {
    ...
    test('should change color scheme', async ({ page }) => {
      ...
      const colorSchemeSelect = page
        .getByRole('combobox', { name: /couleurs|colors|schéma/i })
        .first();
  ...
  test.describe('Graph Physics', () => {
    ...
    test('should adjust physics parameters', async ({ page }) => {
      ...
      if (await physicsButton.isVisible().catch(() => false)) {
        ...
        // Adjust attraction
        const attractionSlider = page
          .locator('input[type="range"]')
          .filter({ hasText: /attraction/i })
          .first();
  ...
  test.describe('Local Graph Mode', () => {
    test('should show local graph for selected note', async ({ page }) => {
      ...
      // Enable local mode
      const localModeToggle = page
        .getByRole('checkbox', { name: /local|voisinage|neighborhood/i })
        .first();
    ...
    test('should adjust local graph depth', async ({ page }) => {
      ...
      const depthInput = page
        .locator('input[type="number"]')
        .filter({ hasText: /profondeur|depth/i })
        .first();
  ...
  test.describe('Graph Export', () => {
    test('should export graph as image', async ({ page }) => {
      ...
      const exportButton = page
        .getByRole('button', { name: /exporter|export|save.*image/i })
        .first();
