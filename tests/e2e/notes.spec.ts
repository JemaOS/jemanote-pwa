...
test.describe('Notes Management', () => {
  ...
  test.describe('Note Deletion', () => {
    test('should delete a note', async ({ page }) => {
      ...
      const deleteButton = noteElement.getByRole('button', { name: /supprimer|delete|trash/i }).first()
    ...
    test('should permanently delete note from trash', async ({ page }) => {
      ...
      if (await deleteButton.isVisible().catch(() => false)) {
        ...
        // Permanently delete
        const permanentDeleteButton = page.getByRole('button', { name: /supprimer définitivement|delete permanently/i }).first()
  ...
  test.describe('Folder Management', () => {
    test('should create a new folder', async ({ page }) => {
      ...
      // Enter folder name
      const folderInput = page.locator('input[placeholder*="dossier" i], input[placeholder*="folder" i]').first()
    ...
    test('should create note inside folder', async ({ page }) => {
      ...
      const addNoteButton = page.locator(`text=${folderName}`).locator('..').getByRole('button', { name: /plus|add|nouvelle/i }).first()
    ...
    test('should delete folder', async ({ page }) => {
      ...
      const deleteButton = folderElement.getByRole('button', { name: /supprimer|delete|trash/i }).first()
