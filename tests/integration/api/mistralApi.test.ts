...
describe('Mistral API Integration', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle server errors (500)', async () => {
      ...
      await expect(mistralService.summarize('Test', 'short')).rejects.toThrow('Serveur Mistral temporairement indisponible')
    })
    ...
    it('should handle unauthorized errors (401)', async () => {
      ...
      await expect(mistralService.summarize('Test', 'short')).rejects.toThrow('Clé API Mistral invalide')
    })
  ...
  describe('Summary History', () => {
    ...
    it('should retrieve summary history', async () => {
      ...
      await mistralService.saveSummaryToHistory('note-1', 'Note 1', 'Content 1', 'Summary 1', 'short')
      await mistralService.saveSummaryToHistory('note-2', 'Note 2', 'Content 2', 'Summary 2', 'detailed')
