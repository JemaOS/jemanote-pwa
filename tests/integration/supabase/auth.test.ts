...
describe('Supabase Auth Integration', () => {
  describe('Sign Up', () => {
    ...
    it('should handle duplicate email error', async () => {
      ...
      server.use(
        http.post('https://yadtnmgyrmigqbndnmho.supabase.co/auth/v1/signup', async () => {
  ...
  describe('Sign In', () => {
    ...
    it('should handle invalid credentials', async () => {
      server.use(
        http.post('https://yadtnmgyrmigqbndnmho.supabase.co/auth/v1/token', async () => {
          return HttpResponse.json(
  ...
  describe('Password Recovery', () => {
    ...
    it('should handle server error during password reset', async () => {
      server.use(
        http.post('https://yadtnmgyrmigqbndnmho.supabase.co/auth/v1/recover', async () => {
  ...
  describe('Email Verification', () => {
    ...
    it('should handle invalid verification token', async () => {
      server.use(
        http.post('https://yadtnmgyrmigqbndnmho.supabase.co/auth/v1/verify', async () => {
          return HttpResponse.json(
