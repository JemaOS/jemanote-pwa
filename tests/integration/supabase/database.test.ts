...
describe('Supabase Database Integration', () => {
  ...
  describe('Notes CRUD', () => {
    ...
    it('should create multiple notes at once', async () => {
      const notes = [
        { user_id: testUserId, title: 'Note 1', content: 'Content 1', is_pinned: false, is_archived: false },
        { user_id: testUserId, title: 'Note 2', content: 'Content 2', is_pinned: false, is_archived: false },
        { user_id: testUserId, title: 'Note 3', content: 'Content 3', is_pinned: false, is_archived: false },
      ]
    ...
    it('should read notes with user filter', async () => {
      ...
      await supabase.from('notes').insert([
        { user_id: testUserId, title: 'Note A', content: 'Content A', is_pinned: false, is_archived: false },
        { user_id: testUserId, title: 'Note B', content: 'Content B', is_pinned: false, is_archived: false },
      ])
    ...
    it('should filter notes by folder', async () => {
      ...
      await supabase.from('notes').insert([
        { user_id: testUserId, title: 'In Folder', content: 'Content', folder_id: folderId, is_pinned: false, is_archived: false },
        { user_id: testUserId, title: 'No Folder', content: 'Content', folder_id: null, is_pinned: false, is_archived: false },
      ])
    ...
    it('should filter pinned notes', async () => {
      await supabase.from('notes').insert([
        { user_id: testUserId, title: 'Pinned', content: 'Content', is_pinned: true, is_archived: false },
        { user_id: testUserId, title: 'Not Pinned', content: 'Content', is_pinned: false, is_archived: false },
      ])
    ...
    it('should filter archived notes', async () => {
      await supabase.from('notes').insert([
        { user_id: testUserId, title: 'Archived', content: 'Content', is_pinned: false, is_archived: true },
        { user_id: testUserId, title: 'Active', content: 'Content', is_pinned: false, is_archived: false },
      ])
  ...
  describe('Complex Queries', () => {
    ...
    it('should search notes by title', async () => {
      await supabase.from('notes').insert([
        { user_id: testUserId, title: 'JavaScript Tips', content: 'Content', is_pinned: false, is_archived: false },
        { user_id: testUserId, title: 'TypeScript Guide', content: 'Content', is_pinned: false, is_archived: false },
        { user_id: testUserId, title: 'Python Basics', content: 'Content', is_pinned: false, is_archived: false },
      ])
