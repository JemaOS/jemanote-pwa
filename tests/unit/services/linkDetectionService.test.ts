...
describe('linkDetectionService', () => {
  ...
  describe('detectLinks', () => {
    ...
    it('should return empty array when no similar notes exist', async () => {
      const currentNote = createMockNote({
        content:
          'This is a very long content about machine learning algorithms and neural networks. It discusses deep learning techniques.',
      });
      const allNotes = [
        createMockNote({
          id: 'different-1',
          content:
            'Completely different topic about cooking recipes and food preparation techniques.',
        }),
      ];
    ...
    it('should detect similar notes based on keywords', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning is a subset of artificial intelligence. It involves training algorithms on data. Deep learning neural networks.',
      });
      const allNotes = [
        createMockNote({
          id: 'similar',
          content:
            'Artificial intelligence and machine learning are transforming industries. AI algorithms process data. Deep learning applications.',
        }),
        createMockNote({
          id: 'different',
    ...
    it('should exclude current note from suggestions', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning algorithms and artificial intelligence concepts. Deep learning neural networks.',
      });
      const allNotes = [
        currentNote,
        createMockNote({
    ...
    it('should limit results to top 5 suggestions', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning and artificial intelligence. Deep learning neural networks training algorithms.',
      });
    ...
    it('should sort suggestions by confidence', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Python programming language for data science and machine learning. Deep learning neural networks.',
      });
      const allNotes = [
        createMockNote({
          id: 'low-match',
        ...
        createMockNote({
          id: 'high-match',
          content:
            'Python machine learning libraries and data science tools. Deep learning algorithms.',
        }),
        createMockNote({
          id: 'medium-match',
    ...
    it('should include common keywords in suggestions', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning algorithms and neural networks. Deep learning artificial intelligence.',
      });
      const allNotes = [
        createMockNote({
          id: 'similar',
          content:
            'Neural networks and machine learning techniques. Deep learning AI applications.',
        }),
      ];
    ...
    it('should include reason in suggestions', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning and artificial intelligence concepts. Deep learning neural networks algorithms.',
      });
      const allNotes = [
        createMockNote({
          id: 'similar',
    ...
    it('should cap confidence at 100', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning artificial intelligence deep learning neural networks algorithms data science.',
      });
      const allNotes = [
        createMockNote({
          id: 'identical',
    ...
    it('should ignore notes with short content', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning and artificial intelligence concepts with deep learning algorithms. Data science applications.',
      });
      const allNotes = [
        createMockNote({
          id: 'short',
        ...
        createMockNote({
          id: 'long',
          content:
            'Machine learning applications in various industries including healthcare and finance. Data science and AI.',
        }),
      ];
    ...
    it('should handle French stop words correctly', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          "Le machine learning et les algorithmes sont très importants pour l'intelligence artificielle.",
      });
      const allNotes = [
        createMockNote({
          id: 'french',
          content:
            "Les algorithmes de machine learning sont utilisés dans l'intelligence artificielle.",
        }),
      ];
    ...
    it('should handle special characters in content', async () => {
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning 2024 AI ML concepts neural networks deep learning algorithms data science.',
      });
      const allNotes = [
        createMockNote({
          id: 'special',
          content:
            'AI ML and neural networks in 2024. Deep learning algorithms and data science applications.',
        }),
      ];
  ...
  describe('detectLinksWithAI', () => {
    it('should use AI to detect links', async () => {
      ...
      const allNotes = [
        createMockNote({
          ...
          title: 'ML Basics',
          content:
            'Introduction to machine learning algorithms. Deep learning and neural networks.',
        }),
        createMockNote({
          id: 'note-2',
          title: 'AI Overview',
    ...
    it('should fallback to keyword detection on AI error', async () => {
      ...
      const currentNote = createMockNote({
        id: 'current',
        content:
          'Machine learning and artificial intelligence. Deep learning neural networks algorithms data science.',
      });
      const allNotes = [
        createMockNote({
          id: 'similar',
    ...
    it('should handle malformed AI response', async () => {
      ...
      const allNotes = [createMockNote({ id: 'note-1', content: 'Content.' })];
  ...
  describe('keyword extraction', () => {
    it('should filter out stop words', async () => {
      const currentNote = createMockNote({
        content:
          'Le la les un une des du de et ou mais donc car ni que qui quoi dont où pour par avec sans dans sur sous entre vers chez à ce cet cette ces mon ton son notre votre leur je tu il elle nous vous ils elles on être avoir faire dire pouvoir aller voir savoir est sont était a ai as ont avons avez',
      });
      const allNotes = [createMockNote()];
    ...
    it('should extract words longer than 3 characters', async () => {
      ...
      const allNotes = [
        createMockNote({
          content:
            'Machine learning algorithms are powerful tools. Deep neural networks applications.',
        }),
      ];
  ...
  describe('similarity calculation', () => {
    ...
    it('should return 100 for identical content', async () => {
      const content =
        'machine learning artificial intelligence deep neural networks algorithms data science';
      const currentNote = createMockNote({ id: 'current', content });
      const allNotes = [createMockNote({ id: 'identical', content })];
